...
class Clarify(object):
    """
    Python CLI Utility specifically targeted to assist with performing common tasks on the AWS cloud as easy as possible. It is a
    wrapper and enhancement that clarifies the AWS CLI.
